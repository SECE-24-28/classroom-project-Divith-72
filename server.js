...
app.put('/api/posts/title/:title',async(req,res) => {
        try{
            ...
            if(!updatepost){
                res.status(404).json({
                    success: false,
                    message: 'Post with this title not found'
                });
            }
            else {
                res.json({
                    success: true,
                    message: 'Post updated successfully by title!',
                    post: updatepost
                });
           }
...
app.delete('/api/posts/title/:title',async(req,res) =>{
    try{
        ...
        if(!deletepost){
            ...
            res.json({
                success: true,
                message: 'Post deleted successfully by title!',
                post: deletepost
            });
       }
    }
